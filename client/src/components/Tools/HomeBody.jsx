        ...
        <div className="">
            <div className="w-full h-[100vh] relative max-lg:h-[70vh] max-md:h-[50vh]">
                ...
                <div className="absolute inset-0 flex flex-col justify-center ml-10 text-white">
                    ...
                    <Link to='/login' className=' mt-4 text-black py-3 font-medium rounded-md bg-yellow-300 hover:scale-105 hover:bg-yellow-400 duration-200 w-40 text-center max-md:py-2'>Donate now</Link>
                </div>
            </div>
